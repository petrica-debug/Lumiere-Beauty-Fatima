    ...
    <section id="testimonials" className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.name} className="p-8 md:p-10 bg-card border border-border/50 hover:border-gold/30 transition-colors duration-500">
              ...
              <div>
                ...
                <p className="font-body text-xs tracking-[0.2em] uppercase text-accent mt-1">{t.service}</p>
              </div>
            </div>
          ))}
        </div>
